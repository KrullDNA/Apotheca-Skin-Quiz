 ...
 */
class ASQ_Add_To_Cart_Widget extends Widget_Base {

    public function get_name() {
        return 'asq_add_to_cart';
    }

    public function get_title() {
        return __( 'PF Add to Cart', 'apotheca-skin-quiz' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'button_icon', array(
            ...
            'description' => __( 'Icon displayed after the button label.', 'apotheca-skin-quiz' ),
        ) );

        $this->add_control( 'show_price', array(
            'label'        => __( 'Show Price', 'apotheca-skin-quiz' ),
            'type'         => Controls_Manager::SWITCHER,
            'default'      => '',
            'label_on'     => __( 'Yes', 'apotheca-skin-quiz' ),
            'label_off'    => __( 'No', 'apotheca-skin-quiz' ),
            'description'  => __( 'Display the product price above the button.', 'apotheca-skin-quiz' ),
        ) );

        $this->add_control( 'show_quantity', array(
            'label'        => __( 'Show Quantity', 'apotheca-skin-quiz' ),
            'type'         => Controls_Manager::SWITCHER,
            'default'      => '',
            'label_on'     => __( 'Yes', 'apotheca-skin-quiz' ),
            'label_off'    => __( 'No', 'apotheca-skin-quiz' ),
            'description'  => __( 'Show a quantity input next to the button.', 'apotheca-skin-quiz' ),
        ) );
        ...
        $this->add_responsive_control( 'align', array(
            ...
            'default'   => 'left',
            'selectors' => array(
                '{{WRAPPER}} .asq-atc-wrap' => 'text-align: {{VALUE}};',
            ),
        ) );
        ...
        $this->add_group_control( Group_Control_Typography::get_type(), array(
            ...
            'label'    => __( 'Typography', 'apotheca-skin-quiz' ),
            'selector' => '{{WRAPPER}} .asq-atc-btn',
        ) );
        ...
        $this->add_control( 'btn_color', array(
            ...
            'selectors' => array( '{{WRAPPER}} .asq-atc-btn' => 'color: {{VALUE}};' ),
        ) );

        $this->add_control( 'btn_bg', array(
            'label'     => __( 'Background', 'apotheca-skin-quiz' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( '{{WRAPPER}} .asq-atc-btn' => 'background-color: {{VALUE}};' ),
        ) );
        ...
        $this->add_control( 'btn_color_hover', array(
            'label'     => __( 'Text Color', 'apotheca-skin-quiz' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( '{{WRAPPER}} .asq-atc-btn:hover' => 'color: {{VALUE}};' ),
        ) );

        $this->add_control( 'btn_bg_hover', array(
            'label'     => __( 'Background', 'apotheca-skin-quiz' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( '{{WRAPPER}} .asq-atc-btn:hover' => 'background-color: {{VALUE}};' ),
        ) );
        ...
        $this->start_controls_tab( 'button_disabled', array(
            'label' => __( 'Disabled', 'apotheca-skin-quiz' ),
        ) );

        $this->add_control( 'btn_color_disabled', array(
            'label'     => __( 'Text Color', 'apotheca-skin-quiz' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( '{{WRAPPER}} .asq-atc-btn.asq-atc-btn--disabled' => 'color: {{VALUE}};' ),
        ) );

        $this->add_control( 'btn_bg_disabled', array(
            'label'     => __( 'Background', 'apotheca-skin-quiz' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( '{{WRAPPER}} .asq-atc-btn.asq-atc-btn--disabled' => 'background-color: {{VALUE}};' ),
        ) );
        ...
        $this->add_control( 'btn_opacity_disabled', array(
            ...
            'selectors' => array( '{{WRAPPER}} .asq-atc-btn.asq-atc-btn--disabled' => 'opacity: {{SIZE}};' ),
        ) );
        ...
        $this->add_responsive_control( 'btn_padding', array(
            ...
            'separator'  => 'before',
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_control( 'btn_border_radius', array(
            ...
            'size_units' => array( 'px', '%' ),
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_control( 'btn_full_width', array(
            ...
            'default'      => '',
            'selectors'    => array(
                '{{WRAPPER}} .asq-atc-btn' => 'width: 100%; display: block;',
            ),
        ) );
        ...
        $this->add_responsive_control( 'icon_size', array(
            ...
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-btn-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                '{{WRAPPER}} .asq-atc-btn-icon svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_control( 'icon_color', array(
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => array(
                '{{WRAPPER}} .asq-atc-btn-icon' => 'color: {{VALUE}};',
                '{{WRAPPER}} .asq-atc-btn-icon svg' => 'fill: {{VALUE}};',
            ),
        ) );

        $this->add_responsive_control( 'icon_gap', array(
            'label'      => __( 'Spacing', 'apotheca-skin-quiz' ),
            'description'=> __( 'Gap between the label and the icon.', 'apotheca-skin-quiz' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => array( 'px', 'em' ),
            'range'      => array(
            ...
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-btn-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
            ),
        ) );

        $this->add_responsive_control( 'icon_baseline_shift', array(
            'label'       => __( 'Baseline Shift', 'apotheca-skin-quiz' ),
            'description' => __( 'Move the icon up or down to align with the text.', 'apotheca-skin-quiz' ),
            'type'        => Controls_Manager::SLIDER,
            'size_units'  => array( 'px', 'em' ),
            'range'       => array(
            ...
            'selectors'   => array(
                '{{WRAPPER}} .asq-atc-btn-icon' => 'position: relative; top: {{SIZE}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_responsive_control( 'qty_width', array(
            ...
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-qty' => 'width: {{SIZE}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_responsive_control( 'qty_height', array(
            ...
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-qty' => 'height: {{SIZE}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_responsive_control( 'qty_gap', array(
            ...
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-inner' => 'gap: {{SIZE}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_control( 'qty_border_color', array(
            ...
            'type'      => Controls_Manager::COLOR,
            'selectors' => array(
                '{{WRAPPER}} .asq-atc-qty' => 'border-color: {{VALUE}};',
            ),
        ) );
        ...
        $this->add_control( 'qty_border_radius', array(
            ...
            'size_units' => array( 'px', '%' ),
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-qty' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ),
        ) );
        ...
        $this->add_control( 'price_color', array(
            'label'     => __( 'Color', 'apotheca-skin-quiz' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => array( '{{WRAPPER}} .asq-atc-price' => 'color: {{VALUE}};' ),
        ) );

        $this->add_group_control( Group_Control_Typography::get_type(), array(
            'name'     => 'price_typography',
            'label'    => __( 'Typography', 'apotheca-skin-quiz' ),
            'selector' => '{{WRAPPER}} .asq-atc-price',
        ) );
        ...
        $this->add_responsive_control( 'price_spacing', array(
            ...
            'range'      => array( 'px' => array( 'min' => 0, 'max' => 30 ) ),
            'selectors'  => array(
                '{{WRAPPER}} .asq-atc-price' => 'margin-bottom: {{SIZE}}{{UNIT}};',
            ),
        ) );
    ...
    protected function render() {
        ...
        if ( ! empty( $settings['button_icon']['value'] ) ) {
            ob_start();
            echo '<span class="asq-atc-btn-icon">';
        ...
        if ( $is_simple && $is_purchasable ) {
            ...
            // AJAX-loaded content).
            $btn_classes[] = 'asq-atc-btn--disabled';
        }

        echo '<div class="asq-atc-wrap">';

        // Optional price.
        if ( 'yes' === ( $settings['show_price'] ?? '' ) ) {
            echo '<div class="asq-atc-price">' . $the_product->get_price_html() . '</div>';
        }

        echo '<div class="asq-atc-inner">';
        ...
        if ( $is_purchasable && 'yes' === ( $settings['show_quantity'] ?? '' ) && ( $is_simple || $is_variable ) ) {
            ...
            echo '<input type="number" class="asq-atc-qty" value="1" min="1" max="'
        ...
        if ( $is_simple && $is_purchasable ) {
            ...
            printf(
                '<a href="#" data-product_id="%d" data-product_sku="%s" data-quantity="1" data-asq-variable="1" class="%s" rel="nofollow">%s%s</a>',
                $product_id,
                esc_attr( $the_product->get_sku() ),
                esc_attr( implode( ' ', $btn_classes ) ),
                esc_html( $button_text ),
            ...
            printf(
                '<span class="asq-atc-btn asq-atc-btn--disabled">%s%s</span>',
                esc_html__( 'Out of Stock', 'apotheca-skin-quiz' ),
                $icon_html
            );
        }

        echo '</div>'; // .asq-atc-inner
        echo '</div>'; // .asq-atc-wrap
    }
    ...
    private function render_editor_placeholder() {
        ...
        echo '<div class="asq-atc-wrap">';
        if ( 'yes' === ( $settings['show_price'] ?? '' ) ) {
            echo '<div class="asq-atc-price">&pound;19.99</div>';
        }
        echo '<div class="asq-atc-inner">';
        if ( 'yes' === ( $settings['show_quantity'] ?? '' ) ) {
            echo '<input type="number" class="asq-atc-qty" value="1" min="1" step="1">';
        }
        printf(
            '<a href="#" class="asq-atc-btn" onclick="return false;">%s%s</a>',
            esc_html( $settings['button_text'] ?: __( 'Add to Cart', 'apotheca-skin-quiz' ) ),
            $icon_html
        );
        echo '</div></div>';
    }
    ...
    protected function content_template() {
        ?>
        <div class="asq-atc-wrap">
            <# if ( settings.show_price === 'yes' ) { #>
            <div class="asq-atc-price">&pound;19.99</div>
            <# } #>
            <div class="asq-atc-inner">
                <# if ( settings.show_quantity === 'yes' ) { #>
                <input type="number" class="asq-atc-qty" value="1" min="1" step="1">
                <# } #>
                <a href="#" class="asq-atc-btn" onclick="return false;">
                    ...
                    #>
                    <span class="asq-atc-btn-icon">{{{ iconHTML.value }}}</span>
                    <# } #>
                </a>
            </div>
        </div>
